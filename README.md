...
# Как выглядит процесс разработки до внедрения библиотеки ManyInputs
...
# Типичное дублирование кода без внедрения библиотеки ManyInputs
...
# Лаконичное решение с помощью библиотеки ManyInputs
